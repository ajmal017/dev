...
zillow = {
        ...
        "datasets": {
                ...
                "priceToRent ratio by city": {
                        "source": "City/City_PriceToRentRatio_AllHomes.csv",
                        "frequency": "M",
                        "index_cols": ['RegionName', 'State', 'Metro', 'CountyName'],
                        "col_names": ['city', 'state', 'metro', 'county', 'date', 'rent']
                },
                "priceToRent ratio by zipcode": {
                        ...
                        "col_names": ['zipcode', 'city', 'state', 'metro', 'county', 'date', 'rent']
                },
        },
        "housing table": {
